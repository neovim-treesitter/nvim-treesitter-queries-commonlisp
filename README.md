...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-commonlisp/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-commonlisp/actions/workflows/validate.yml)

Neovim tree-sitter queries for **commonlisp**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-commonlisp",
...
- [ ] Changes are scoped to `commonlisp` — do not include files for other languages
